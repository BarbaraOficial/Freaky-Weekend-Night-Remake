...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['Barbara',		'BarbaraOficial',		'Director and programmer of Freaky Weekend Night Remake',							'https://youtube.com/@BarbaraAFOficial',	'5DE7FF'],
            ['Sala de Jogos Oficial',		'JogosOficial',		'Director of Freaky Weekend Night Original',							'https://www.youtube.com/channel/UCx0LxtFR8ROd9sFAq-UxDfw',	'5DE7FF'],
